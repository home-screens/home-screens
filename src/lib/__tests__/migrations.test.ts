...
describe('migration v14: daily weather forecast presentation is configurable', () => {
  it('bumps the schema without changing existing weather modules', () => {
    ...
    expect(migrationsRun).toEqual(['v14: Daily weather forecast presentation is configurable']);
  });
});
...
describe('migration v13: preserve family inputs for the coordinated fold', () => {
  it('keeps legacy people and existing source mappings verbatim', () => {
