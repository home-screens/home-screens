...
export default function SidebarLibrary({
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Filter pills */}
      <div className="flex gap-1.5 px-4 py-2 overflow-x-auto border-b border-neutral-700">
          ...
          filteredMeals.map((meal) => {
            ...
            return (
              <div
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-lg border-1.5 border-transparent hover:bg-neutral-800 transition cursor-pointer ${
              ...
              >
                ...
                >
                  {meal.isFavorite ? (
                    ...
                    <span className="text-neutral-600 hover:text-neutral-400">&#9825;</span>
                  )}
                </button>
              </div>
            );
      ...
      <div className="px-4 py-2.5 border-t border-neutral-700">
        <button
          type="button"
          className="w-full py-2.5 text-sm font-semibold border border-dashed border-neutral-700 rounded-lg text-neutral-500 hover:border-amber-500 hover:text-amber-500 hover:bg-amber-500/8 transition"
          onClick={onAddMeal}
        >
          + Add New Meal
        </button>
