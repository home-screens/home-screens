  ...
  return (
    <div className="h-full w-full flex items-center gap-3 px-4">
      ...
      <div className="relative">
        <IconButton ariaLabel="Brightness" onClick={() => setBrightnessOpen((v) => !v)}>
