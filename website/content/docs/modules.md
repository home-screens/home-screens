...
- **Full-Screen Weather** ([reference](/docs/module-reference#full-screen-weather)): a weather wall, with the background tinted by the sky outside. Views: **Panorama**, **Almanac**, **Ambient**, **Week** and **Hourly**, each with a portrait and a landscape layout. Needs a [location](/docs/weather).
