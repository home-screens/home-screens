...
export const metadata: Metadata = {
  ...
  description:
    'An open-source smart display system for Raspberry Pi. 36 built-in modules, drag-and-drop editor, plugin system. A free, self-hosted alternative to MagicMirror and Dakboard.',
  keywords: [
    'smart display',
    'raspberry pi',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: 'Home Screens',
              description:
                'An open-source smart display system for Raspberry Pi with 36 built-in modules, a drag-and-drop visual editor, and a plugin system.',
