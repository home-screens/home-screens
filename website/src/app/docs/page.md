...
An open-source smart display system for Raspberry Pi. 36 modules, visual editor, 5 weather providers. Free forever. {% .lead %}
...
- **36 modules** — clock, weather, calendar, news, stocks, sports, and more
